...
class Place(BaseModel, Base):
    ...
    @property
    def amenities(self):
        """ Getter attribute to retrieve a list of Amenity """
    ...
    @property
    def reviews(self):
        """ Getter attribute to retrieve a list of Review """
        from models import storage
        reviewsList = []
    ...
    def amenities(self, amenity):
        """ Setter attribute to store a list of Amenity """
        if isinstance(amenity, Amenity):
            self.amenities_ids.append(amenity.id)
